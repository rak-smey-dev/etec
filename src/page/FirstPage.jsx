  ...
  return (
    <div className="min-h-full  bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 flex flex-col transition-colors duration-300">
      ...
      <header className="relative z-10 text-center pt-16 px-4">
        ...
        <p className="text-2xl md:text-3xl text-amber-700 dark:text-amber-300 mb-2">
          Khmer Recipes
        </p>
        <div className="w-24 h-1 bg-amber-500 dark:bg-amber-400 mx-auto mt-6 rounded-full"></div>
      </header>
      ...
      <main className="flex-grow flex items-center justify-center px-4 py-12">
        <div className="max-w-4xl mx-auto text-center">
          {/* Welcome Message */}
          <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-3xl p-8 md:p-12 shadow-2xl border border-amber-200 dark:border-gray-700 mb-12 transition-colors duration-300">
            ...
            <button
              ...
              className="group relative bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 dark:from-amber-500 dark:to-orange-500 dark:hover:from-amber-600 dark:hover:to-orange-600 text-white font-bold text-xl py-4 px-12 rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-300 transform hover:scale-105"
            >
          ...
          {/* Quick Preview */}
          <div className="bg-amber-900/90 dark:bg-gray-800/90 text-amber-50 dark:text-gray-100 rounded-3xl p-8 backdrop-blur-sm transition-colors duration-300">
      ...
      <footer className="relative z-10 text-center pb-8 px-4">
        ...
        <div className="flex justify-center space-x-4 mt-4">
          <span className="text-xs text-amber-600 dark:text-amber-400">Traditional</span>
          <span className="text-xs text-amber-600 dark:text-amber-400">Authentic</span>
          <span className="text-xs text-amber-600 dark:text-amber-400">Delicious</span>
        </div>
      </footer>

      {/* Floating Elements */}
      <div className="absolute top-1/4 left-10 animate-bounce">
        <div className="text-4xl opacity-20 dark:opacity-30">🥬</div>
      </div>
      <div className="absolute top-1/3 right-16 animate-pulse">
        <div className="text-4xl opacity-20 dark:opacity-30">🍚</div>
      </div>
      <div className="absolute bottom-1/4 left-20 animate-bounce delay-1000">
        <div className="text-4xl opacity-20 dark:opacity-30">🌶️</div>
      </div>
